package net.andreinc.jvbe.annotations.exp.validators;

import lombok.AllArgsConstructor;
import lombok.NoArgsConstructor;
import net.andreinc.jvbe.annotations.exp.JsAssert;
...
import static net.andreinc.jvbe.utils.TimeAction.recordTimeAndDo;
